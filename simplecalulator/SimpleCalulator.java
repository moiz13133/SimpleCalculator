...
final int HEIGHT=50, WIDTH=50, H_SPACE=20,V_SPACE=20;
...
super(frameText);
int tempX=99, y=TOPY;
displayLabel.setBounds(tempX,y,440,HEIGHT);
...
memoryButton[i].setBackground(Color.YELLOW);
y+=HEIGHT+V_SPACE;
}
...
specialButton[i].setBackground(Color.YELLOW);
...
operatorButton[i].setBackground(Color.YELLOW);
...
{
new SimpleCalulator("CALCULATOR");
}
}
...
{
SimpleCalulator cl;
MyOperatorButton(int x,int y, int width,int height,String cap, SimpleCalulator clc)
{
super(cap);
setBounds(x,y,width,height);
this.cl=clc;
...
if(opText.equals("1/x"))
   ...
   try
       ...
       cl.displayLabel.setText(SimpleCalulator.getFormattedText(tempd));}
...
{
SimpleCalulator cl;
MyMemoryButton(int x,int y, int width,int height,String cap, SimpleCalulator clc)
{
super(cap);
setBounds(x,y,width,height);
this.cl=clc;
...
case 'R':
   cl.displayLabel.setText(SimpleCalulator.getFormattedText(cl.memValue));break;
case 'S':
   cl.memValue=0.0;
case '+':
...
{
SimpleCalulator cl;
MySpecialButton(int x,int y, int width,int height,String cap, SimpleCalulator clc)
{
super(cap);
setBounds(x,y,width,height);
this.cl=clc;
